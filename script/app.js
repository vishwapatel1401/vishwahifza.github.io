...
(function(){
    ...
    function DisplayHumanResourcePage(){
        console.log("Human resource Page called!");
    }
    /**
    ...
    function DisplayContactListPage(){
        ...
        if(localStorage.length > 0){
            ...
            $("button.delete").on("click", function(){
               if(confirm("Delete contact,Are you sure??")){ //ask the user if they are sure or not to delete the data.
                   localStorage.removeItem($(this).val())
               }
               location.href="contact-list.html"; //Goback to contact list
            });
            $("button.edit").on("click", function(){
                location.href = "edit.html#" + $(this).val(); //open the edit page
            });
    ...
    function DisplayLoginPage(){
        ...
        $("#loginButton").on("click",function(){
            ...
            //checks the password validations.
    ...
    function DisplayRegisterPage(){
        ...
        // Checks the firstname and lastname validations.
        ...
        $("#email").on('change', function(){
            //Do the validations for email address.
